  ...
  return (
    <Modal title="Settings" onClose={onClose}>
      ...
      <div className="card" style={{ marginBottom: 12 }}>
        ...
        <div className="stat"><span className="k">ALPHA VANTAGE (fundamentals)</span><span className={`v ${cls(st.alphavantage)}`}>{st.alphavantage}</span></div>
      ...
      <div className="muted-box" style={{ marginTop: 12, fontSize: 11 }}>
        ...
        <span className="dim">ANTHROPIC_API_KEY, CLAUDE_MODEL, FINNHUB_API_KEY, ALPHAVANTAGE_API_KEY.</span>{' '}
